...
<?php if (!empty($_SESSION['login_failed'])) {
  echo '<div class="card mb-4 py-3 border-bottom-danger">
          ...
          .'</div>
                  ...
                  <form action="dashboard.php" method="post" class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="exampleInputEmail" aria-describedby="emailHelp" placeholder="User Name">
                    </div>
                    <div class="form-group">
